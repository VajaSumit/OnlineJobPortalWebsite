    ...
    public partial class ManageJobSeekers : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            ...
            else
            {
                ...
                string query = "select *from RegistrationForJSTbl";
        ...
        protected void DataGridViewForDisplayData_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from RegistrationForJSTbl where Id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "select *from RegistrationForJSTbl WHERE Name LIKE '%' + @nm + '%' ";
            SqlCommand cmd = new SqlCommand(query, con);
