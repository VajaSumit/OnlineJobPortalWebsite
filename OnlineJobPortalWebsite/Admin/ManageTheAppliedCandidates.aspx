<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageTheAppliedCandidates.aspx.cs" Inherits="OnlineJobPortalWebsite.Admin.ManageTheAppliedCandidates" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-none d-sm-inline-block form-inline mr-auto offset-9">
                            ...
                            <div class="input-group">
                                <asp:RequiredFieldValidator Text="*" ErrorMessage="*" ControlToValidate="txtname" runat="server" Display="Dynamic" ForeColor="Red" />
                                <asp:TextBox runat="server" ID="txtname" CssClass="form-control bg-light border-0 small" name="txtname" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search By Name...'" placeholder="Search By Name..." />
                        ...
                        <div class="row gutters">
                            ...
                            <div class="table-responsive mt-4">
                                <asp:GridView runat="server" ID="DataGridViewForDisplayData" PageSize="8" OnRowDeleting="DataGridViewForDisplayData_RowDeleting" DataKeyNames="JAId" Font-Size="XX-Small" HeaderStyle-Font-Size="XX-Small" CssClass="table table-borderless table-hover" AllowPaging="true" OnPageIndexChanging="DataGridViewForDisplayData_PageIndexChanging" AllowSorting="False" Width="100%" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="LastDate">
                                            ...
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label Text='<%# Eval("LastDate") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="UserImage">
                                            ...
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:HyperLink NavigateUrl='<%# Eval("UserImage") %>' runat="server" Font-Bold="true" ForeColor="#3333ff" Font-Underline="true" Text="View" Target="_blank" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Resume">
                                            ...
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:HyperLink NavigateUrl='<%# Eval("Resume") %>' runat="server" Font-Bold="true" ForeColor="#3333ff" Font-Underline="true" Text="View" Target="_blank" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
