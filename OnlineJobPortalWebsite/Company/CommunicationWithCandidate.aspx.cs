...
{
    public partial class CommunicationWithJobSeeker : System.Web.UI.Page
    {
        ...
        {
            int id1 = int.Parse(((sender as Button).NamingContainer.FindControl("lblIdForEditTakingAction") as Label).Text);
            int id2 = int.Parse(((sender as Button).NamingContainer.FindControl("lblappliedcandidatestatusId") as Label).Text);
            Session["Id1ForEditTakeAction"] = id1.ToString();
            Session["Id2ForEditTakeAction"] = id2.ToString();

            Response.Redirect("../Company/EditTakeAction.aspx");
        }
    }
}