<%@ Page Title="" Language="C#" MasterPageFile="~/Company/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="PostJobs.aspx.cs" Inherits="OnlineJobPortalWebsite.Company.AddNewJob" %>
    ...
    <div class="container mt-50">
        <div class="row gutters">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-40">
                <div class="card h-100">
                    <div class="card-body">
                        <h3 style="margin-bottom: 12px; margin-top: 3px; margin-left: 3px; font-weight: bold; color: gray">Post A New Job</h3>
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group mt-6">
                                    ...
                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtnumberofpost_FilteredTextBoxExtender" runat="server" BehaviorID="txtnumberofpost_FilteredTextBoxExtender" TargetControlID="txtnumberofpost" FilterType="Numbers" />
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <%--<asp:RegularExpressionValidator ErrorMessage="Please Enter Only Letter , Not Number's..." ControlToValidate="txteducation" ValidationExpression="^[a-z A-Z ]+$" runat="server" Display="Dynamic" ForeColor="Red" Text="*" />--%>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <%--<asp:RegularExpressionValidator ErrorMessage="Please Enter Only Number , Not Letter's..." ControlToValidate="txtsalary" ValidationExpression="" runat="server" Display="Dynamic" ForeColor="Red" Text="*" />--%>
