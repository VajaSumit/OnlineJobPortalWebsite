<%@ Page Title="" Language="C#" MasterPageFile="~/Company/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="CommunicationWithCandidate.aspx.cs" Inherits="OnlineJobPortalWebsite.Company.CommunicationWithJobSeeker" %>
        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-40">
                <div class="card h-100">
                    <div class="card-body">
                        <h3 style="margin-bottom: 12px; margin-top: 3px; margin-left: 3px; font-weight: bold; color: gray">Applied Candidate Status :</h3>
                                                ...
                                                <ul>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-append font-weight-bold">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:Button Text="Edit Action" runat="server" CssClass="btn btn-sm btn-secondary" Font-Size="Smaller" ID="btnedit" Height="20px" OnClick="btnedit_Click" />
                                                        </div>
                                                    </div>
                                                </ul>
                                            </td>
