<%@ Page Title="" Language="C#" MasterPageFile="~/JobSeeker/JobSeeker.Master" AutoEventWireup="true" CodeBehind="RecruiterMessage.aspx.cs" Inherits="OnlineJobPortalWebsite.JobSeeker.RecruiterMessage" %>
        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-40">
                <div class="card h-100">
                    <div class="card-body">
                        <h3 style="margin-bottom: 12px; margin-top: 3px; margin-left: 3px; font-weight: bold; color: gray">Recruiter Message :</h3>
                        ...
                        <div class="d-none d-sm-inline-block form-inline offset-7">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <asp:Button Text="Search" ID="btnsearch" CssClass="btn btn-primary" Font-Size="XX-Small" runat="server" OnClick="btnsearch_Click" />
                                </div>
                            </div>
                                    ...
                                    <table class="table table-sm table-responsive table-borderless">
                                        <tr class="company-img">
                                            <td>
                                                ...
                                                <img src='<%#Eval("UserImage")%>' style="border-radius: 50%; border-width: 1px; border-color: black;" runat="server" height="120" width="130" />
                                            ...
                                            <td class="job-tittle job-tittle2">
                                                <a href="#">
                                                    <h5>
                                                        <asp:Label ID="lbljobtitle" CssClass="font-weight-bold text-truncate" runat="server" Text='<%# Eval("JobTitle") %>'></asp:Label>
                                                    </h5>
                                                </a>
                                                <ul>
