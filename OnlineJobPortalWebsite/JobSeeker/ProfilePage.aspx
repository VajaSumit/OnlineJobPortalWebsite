<%@ Page Title="" Language="C#" MasterPageFile="~/JobSeeker/JobSeeker.Master" AutoEventWireup="true" CodeBehind="ProfilePage.aspx.cs" Inherits="OnlineJobPortalWebsite.JobSeeker.ProfilePage" %>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="FileUploadForResume" class="form-label">Edit Resume :</label>
                                    <asp:FileUpload ID="FileUploadForResume" runat="server" CssClass="form-control" />
                                    <p style="font-size: x-small; color: gray; margin-left: 5px;">Only PDF</p>
                                </div>
                            </div>

                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group mt-3">
                                    <label for="FileUploadForResume" class="form-label">View Resume :</label>
                                    <br />
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-right">
                                    ...
                                    <asp:Button Text="Cancel" runat="server" ID="btnCancel" CssClass=" btn head-btn2" OnClick="btnCancel_Click" />
                                    <asp:Button Text="Update" runat="server" ID="btnUpdate" CssClass=" btn head-btn2" OnClick="btnUpdate_Click" />
